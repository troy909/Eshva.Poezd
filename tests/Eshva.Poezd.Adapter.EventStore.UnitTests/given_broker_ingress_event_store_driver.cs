...
namespace Eshva.Poezd.Adapter.EventStore.UnitTests
{
  public class given_broker_ingress_event_store_driver
  {
    [Fact]
    public void when_initialize_more_than_once_it_should_fail()
    {
      var driver = new BrokerIngressEventStoreDriver(MakeDriverConfiguration(), Mock.Of<IStreamSubscriptionRegistry>());
    ...
    public void when_initialize_it_should_create_subscription_for_each_api()
    {
      ...
      var sut = new BrokerIngressEventStoreDriver(MakeDriverConfiguration(), subscriptionRegistryMock.Object);
    ...
    private static BrokerIngressEventStoreDriverConfiguration MakeDriverConfiguration() =>
      new BrokerIngressEventStoreDriverConfiguration();
