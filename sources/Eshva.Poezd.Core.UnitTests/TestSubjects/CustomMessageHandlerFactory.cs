...
namespace Eshva.Poezd.Core.UnitTests.TestSubjects
{
  public sealed class CustomMessageHandlerFactory : MessageHandlerAdapter
  {
    ...
    private sealed class VentureMessageHandlerAdapter<TMessage> : IHandleMessage<TMessage>
    {
      ...
      {
        _ventureHandler = (ICustomHandler<TMessage>)ventureHandler ?? throw new ArgumentNullException(nameof(ventureHandler));
      }
      ...
      public Task Handle([NotNull] TMessage message, [NotNull] IPocket poezdContext)
      {
        ...
        return _ventureHandler.Handle(message, MakeCustomMessageHandlingContext(poezdContext));
      }

      private static CustomMessageHandlingContext MakeCustomMessageHandlingContext(IPocket context)
      {
      ...
      private readonly ICustomHandler<TMessage> _ventureHandler;
    }
  }
}
