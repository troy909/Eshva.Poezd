...
namespace Eshva.Poezd.KafkaCoupling
{
  ...
  {
    public IngressKafkaDriver([NotNull] IngressKafkaDriverConfiguration configuration)
    {
      ...
      IServiceProvider serviceProvider)
    {
      ...
      _logger = (ILogger<IngressKafkaDriver>) serviceProvider.GetService(typeof(ILogger<IngressKafkaDriver>)) ??
                throw new PoezdConfigurationException($"Can not get a logger of type {typeof(ILogger<IngressKafkaDriver>).FullName}.");
    ...
    private ILogger<IngressKafkaDriver> _logger;
